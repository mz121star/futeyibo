...
define(['ieextend','jquery-ui', 'jquery-fullPage', 'jquery-mousewheel','coveringBad','head','modernizr'], function (extend) {
    ...
    $('#fullpage').fullpage({
        ...
        afterLoad: function(anchorLink, index, slideAnchor, slideIndex){
            ...
            if(index==6){
                //s6=0;
                //$(".bg61").delay(0).animate({opacity: 1,'top': "0"},0);
                //$(".bg61 img").delay(0).animate({'margin-top': "0"},0);
            }
            if(index==12){
                times=1;
        ...
        onLeave: function(index, nextIndex, direction){
            ...
            if(index==6){
                ...
                $(".bg61 img").delay(1000).animate({'margin-top':0},0,function(){
                    $(".bg61 img").stop(true);
                });*/
            }
            if(index==11){
            ...
            if(index==9){
               ...
               // $('.bg1111_1').animate({top:300},0);
                ...
                //$(".bg1111_1 img").delay(1000).animate({'margin-top': "0px"},0);
            }
    ...
    $(".section6") .mousewheel(function (e) {
        ...
        if(e.deltaY<0){     //寰€涓嬫粴鍔�
            s6=s6+s6move;
            if(s6<=$(window).height()){
                $(".bg61").animate({opacity: 1,'top': s6+"px"},1000);
                $(".bg61 img").animate({'margin-top':-s6+'px'},1000);
                stopEvent();
                return false;
            }
        }
        ...
        /*s6=0;
       $(".bg61").delay(1000).animate({opacity: 1,'top': "0px"},1000,function(){
              $(".bg61 img").css('margin-top',0);
        });*/

    });
    var s9=0;
    var s9move = $(window).height()*0.25;
    $(".section10") .mousewheel(function (e) {

        if($(".bg1111_1").is(":animated")|| $(".bg1111_1 img").is(":animated")){
            stopEvent();
            return false;
        }
        $(".bg1111_1").css('overflow','hidden');
        //if(s9<-300){
       ...
       // }
        if(e.deltaY<0){     //寰€涓嬫粴鍔�
            s9=s9-s9move;
            if(s9>= -$(window).height()){
                $(".bg1111_1").animate({opacity: 1,'top': s9+"px"},1000);
                $(".bg1111_1 img").animate({'margin-top': -s9+"px"},1000);
                stopEvent();
                return false;
            }
        }
